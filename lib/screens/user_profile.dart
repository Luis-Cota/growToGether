...
class UserProfile extends StatelessWidget{
  ...
  final String description = "Mi tirada es convertir cada rincón en un chulada de jardín. No le saco al solazo ni a ensuciarme las manos con la tierra. Soy el mero pipiolo de las flores, los árboles y las yerbitas. Dicen que el que es perico donde quiera es verde, ¡y yo estoy más verde que un aguacate en esto de la jardinería! Me encanta compartir los secretos para que tus plantas no se achicopalen. Si tienes dudas, pregunta sin broncas. ¡Arre con la que barre!";
  ...
  Widget build(BuildContext context) {
    return (user == null)? const LoginPage()
    : Scaffold(
      appBar: AppBar(
...
SizedBox(
    width: 100, height: 100,
      child : TextButton(onPressed: follows, child:
                Text("Sigiendo: \n $followings",
